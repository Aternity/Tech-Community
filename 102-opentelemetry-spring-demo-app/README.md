...
Download a local copy of the file [docker-compose.yml](docker-compose.yml), [click here to download](https://github.com/Aternity/Tech-Community/blob/main/102-opentelemetry-spring-demo-app/docker-compose.yml) and for example save in the directory `Tech-Community/102-opentelemetry-spring-demo-app`
